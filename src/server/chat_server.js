...
socket.on('invite', function(msg) {//прослушивание события invite
   let id_room= msg.to+'VS'+msg.to; //генерация ид комнаты из ников 2 юзеров, т.к. ники уникальны, ид комнаты тоже
    joinRoom(socket, id_room,msg.to+' VS '+msg.to); //имя комнаты
